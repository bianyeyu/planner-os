  ...
  return (
    <div className="flex flex-col w-64 bg-gray-800">
      <div className="flex items-center justify-center h-16 bg-gray-900">
        <span className="text-white font-bold uppercase">Planner OS</span>
      </div>
        ...
        <ul className="flex flex-col py-4">
          {navItems.map((item) => (
            <li key={item.name}>
              <Link
                to={item.path}
                className={`flex items-center px-6 py-2 mt-1 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 ${
                  location.pathname === item.path ? 'bg-gray-700 bg-opacity-25' : ''
                }`}
              >
